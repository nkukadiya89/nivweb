    ...
    <div id="wapper">
                ...
                <div class="row ">
                    ...
                    <div class="col col-12 col-md-6">
                        <div class="content-part animatable fadeInRight">
                            ...
                            <p>
                                Welcome to Nivzen Technologies, where web-based software craftsmanship converges with a
                                commitment to
                                excellence. As an emerging technologies company, we champion innovation, deliver value
                                to clients and
                                society, and celebrate a track record of over 500 projects, 350+ happy clients, and a
                                team of 30+
        ...
        <div class="services">
            <div class="container">
                ...
                <p>At Nivzen Technologies, we are your partners in realizing a powerful brand identity and establishing
                    a
                    corporate presence that stands out in the industry. Based in India, we specialize in providing
                    top-quality,
                    ...
                    <div class="owl-carousel owl-services">
                        <div class="item">
                            ...
                            <p>Whether you require a custom website designed to your exact specifications or a more
                                standardized
                                solution, our expert team excels in all facets of web development. We are committed to
                                delivering
                        ...
                        <div class="item">
                            ...
                            <p>Achieve your business goals with our top-notch mobile app development service. Our
                                dedicated team of
                                app developers is equipped to transform your ideas into engaging and functional mobile
                                applications,
                                ensuring
                        ...
                        <div class="item">
                            ...
                            <p>Unlock the potential of Python for your web projects with our custom Python web
                                ...
                                As a trusted Python web development company, we deliver scalable and efficient solutions
                                tailored to
                                your specific
                        ...
                        <div class="item">
                            ...
                            <p>As a leading React JS development company, we harness the power of this cutting-edge
                                JavaScript library
                                to create dynamic and responsive web applications. Our expertise spans front-end web
                                development with
                                React, crafting web applications using React JS, and providing tailored solutions as a
                                React JS web
                                development company.
                            </p>
                        ...
                        <div class="item">
                            ...
                            <p>Validate the feasibility of your ideas with our Proof of Concept (POC) development
                                services. Build
                                prototypes that provide tangible evidence, enabling informed decisions and securing a
                                robust foundation
                        ...
                        <div class="item">
                            ...
                            <p>Accelerate your product launch with our Minimum Viable Product (MVP) development
                                services. Develop a
                                scaled-down version for efficient market entry, gathering valuable user feedback before
                                full-scale
                                deployment.
                            </p>
                        ...
                        <div class="item">
                            ...
                            <p>Ensure project success with our meticulous requirement analysis services. We
                                ...
                                and document your needs, laying the groundwork for a seamless development process and
                                successful project
                                outcomes
                            </p>
                            ...
                            <div class="bannerContent">
                                <div class="container">
                                    <div class="testimcont">
                                        ...
                                        <p>
                                            “ I've been working with Nirav for more than two years now where helped me
                                            build our platfrom from the ground up.
                                            In this period Nirav has displayed project management capabilities where he
                                            did not only took care of the back end development but also took charge of
                                            the front end development through his network. ”
                                        </p>
                                        <h3>Vincenzo F</h3>
                            ...
                            <div class="bannerContent">
                                <div class="container">
                                    <div class="testimcont">
                                        ...
                                        <p>
                                            “ Having started working with Nivzen Technologies after a personal
                                            recommendation nearly two years ago, we haven't looked back.
                                            Our project required a large amount of industry specific methodology and
                                            algorithms to be implemented into our new software, which the team handled
                                            well.
                                            Also, the post development support that Nivzen Technologies have provided
                                ...
                                <div class="container">
                                    <div class="testimcont">
                                        ...
                                        <p>
                                            ...
                                            The project manager as a single point of contact is doing great job in
