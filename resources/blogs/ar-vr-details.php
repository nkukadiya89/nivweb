        ...
        <div class="blogdtlpage">
            <div class="container">
                ...
                <div class="row mt-5 flex-md-row-reverse">
                    <div class="col col-12 col-md-8">
                        <div class="content-part">
                            <h3>How is AR and VR used in Healthcare</h3>
                ...
                <div class="row mt-5">
                    <div class="col col-12 col-md-8">
                        <div class="content-part">
                            <h3>How is AR and VR used in Games?</h3>
                ...
                <div class="mt-5">
                    ...
                    <p>To conclude, Augmented Reality (AR) and Virtual Reality (VR) have incredible potential to
                        revolutionise gaming and provide players with more immersive and engaging experiences.
                        With the incorporation of AR and VR, developers can experiment with the boundaries of reality
                        and put players into entirely different worlds.</p>
