...
<body>
    <div id="wapper">
        ...
        <div class="innerbanner">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="bnrimg">
                        <img src="images/Hire-Django-Developer.png" alt="Hire-Django-Developer" />
                    </div>
                </div>
            </div>
        </div>
        <div class="about-react">
            <div class="container">
                <div class="normaltxt">
                    we offer a comprehensive suite of Django development services tailored to meet the diverse needs of
                    businesses. From initial consulting to post-launch support, our team is here to guide you through
                    every stage of the development process.
                    We believe in building long-term relationships with our clients. Our collaborative approach ensures
                    that your input is valued throughout the development process, resulting in solutions that truly meet
                    your needs.
                ...
                <div class="row ">
                    <div class="col col-12 col-md-6">
                        <div class="content-part">
                            ...
                            <p>
                                At Nivzen Technologies, we specialize in developing high-performance web applications
                                using Django, one of the most powerful and flexible web frameworks available today. As a
                                leading Django development company, we provide comprehensive solutions that combine
                                cutting-edge technology with innovative design to meet the unique needs of your
                                business. Our expert team is dedicated to delivering secure, scalable, and efficient web
                                applications that empower businesses to achieve their goals and drive growth.
                                <br /><br />
                                we recognize the transformative power of Django in building robust web applications that
                                drive business success. Whether you’re looking to develop a custom web application,
                                integrate APIs, or create an e-commerce platform, our team is equipped to deliver
                    ...
                    <div class="col col-12 col-md-6 text-center ">
                        <div class="image-part">
                            <img src="images/hire-images/Django-Developer.png" alt="hier-Django-Developer" />
                        </div>
                    </div>
                </div>
            </div>
